sap.ui.define([
		...
		return BaseObject.extend("plan.model.ListSelector", {
			 ...
			 * @return {plan.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
